...
| T007 | Implementar o modo `--piloto` (~10 verbetes + suas formas) e executá-lo: confirmar que o artefato-piloto tem `.syn` materializado, `synwordcount > 0` coerente no `.ifo` e abre em ferramenta StarDict local — valida a premissa 1 do roadmap (L-05) antes da escala                                         | T006         | -           | `spike/001-flexoes/gerar_spike.py` | 🟡          | `[X]`  |
